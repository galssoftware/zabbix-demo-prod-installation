...
Перейдите в раздел Connections → Datasources и добавьте новый источник данных типа PostgreSQL. Обратите внимание, что порт подключения здесь указан 5433, что означает подключение к репликам БД. Не забудьте активировать использование TimecaleDB.
